...
export default class Lower<MessageT> implements Validator<number, number, LowerValidatable<MessageT>>, Message<Function<[Readonly<Value<number> & Inclusive & Maximum & Validatable>], MessageT>>, Maximum, Inclusive {
    maximum: number;
    inclusive: boolean;
