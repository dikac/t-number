...
export default class Integer<MessageT> implements Validator<number, number, boolean, boolean, Readonly<Instance<number, MessageT>>>, Message<(result: Readonly<Value<number>> & Readonly<Validatable>) => MessageT> {
    message: (result: Readonly<Value<number>> & Readonly<Validatable>) => MessageT;
    constructor(message: (result: Readonly<Value<number>> & Readonly<Validatable>) => MessageT);
