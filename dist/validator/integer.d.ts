...
export default class Integer<MessageT> implements Validator<number, number, boolean, boolean, Readonly<Instance<number, MessageT>>>, Message<Function<[Readonly<Value<number>> & Readonly<Validatable>], MessageT>> {
